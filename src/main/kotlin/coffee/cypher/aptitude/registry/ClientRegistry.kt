...
val CLIENT_ABILITY_REGISTRY = mutableMapOf<Identifier, () -> VillagerAbilityClient>()
...
fun runClientRegistrations() {
    ...
    CLIENT_ABILITY_REGISTRY[Aptitude.id("upgrade_enchanted_book")] = { UpgradeEnchantedBookAbilityClient() }
}
